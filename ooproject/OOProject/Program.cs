                        ...
                        switch (wybor)
                        {
                            ...
                            case "2":
                            {
                                ...
                                switch (typPrzejazdu)
                                {
                                    case "1":
                                    {
                                        Console.Write("Przystanek startowy: ");
                                        string startPrz =
                                            Console.ReadLine();
                                    ...
                                    case "2":
                                    {
                                        Console.Write("Lotnisko wylotu: ");
                                        string lotniskoWylotu =
                                            Console.ReadLine();

                                        Console.Write("Lotnisko przylotu: ");
                                        string lotniskoPrzylotu =
                                            Console.ReadLine();

                                        Console.Write("Bramka: ");
                                        string bramka =
                                            Console.ReadLine();
                           ...
                           case "4":
                            {
                                ...
                                if(indeks != -1)
                                {
                                    Wydarzenie wydarzenie =
                                        planer.PobierzWydarzenie(indeks);
                                        ...
                                        while(true)
                                        {
                                            ...
                                            switch(wyborWyd)
                                            {
                                                ...
                                                case "2":
                                                    ...
                                                    Console.WriteLine(
                                                        $"Potwierdzone: {wydarzenie.CzyPotwierdzone()}");
                                                    break;
                                                ...
                                                case "3":
                                                {
                                                    ...
                                                    bool sukces =
                                                        planer.ZmienCzasTrwaniaWydarzenia(indeks, nowyCzas);
                                        ...
                                        while(true)
                                        {
                                            ...
                                            switch(wyborNocleg)
                                            {
                                                ...
                                                case "2":
                                                    ...
                                                    Console.WriteLine(
                                                        $"Potwierdzone: {nocleg.CzyPotwierdzone()}");
                                                    break;
                                                ...
                                                case "3":
                                                {
                                                    ...
                                                    bool sukces =
                                                        planer.ZmienCzasTrwaniaNoclegu(indeks, nowyCzas);
